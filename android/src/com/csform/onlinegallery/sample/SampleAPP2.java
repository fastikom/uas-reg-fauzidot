...
public class SampleAPP2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		theme = Themes.THEME1;
		title = getString(R.string.theme1);
		...
		categoryTitle.setTypeface(Typeface.createFromAsset(getAssets(), Themes.getFont(theme)));
		categoryTitle.setText(title);
		init();
		//We don't need this part of code anymore
	...
	public OnItemClickListener gridItemListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			final Animation anim = AnimationUtils.loadAnimation(SampleAPP2.this, R.anim.zoom_out);
	...
	private void initData() {
		...
		i1.setName("travel1");
		i1.setPath("assets://images/image1.jpg");
		images1.add(i1);
		i1 = new ImageItem();
		i1.setName("travel2");
